const contractAddress = "0x92B1ac2f5C2857F6BCc7FEf866DFe1B76Be208b5"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the metamarbles minting app!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Metamarbles is a decentralized NFT project for collecting rarified virtual marbles on the Ethereum testnet Rinkeby. TESTNET DO NOT SEND REAL ETHEREUM!!!';
const h1_presale_coming_soon = "NFT Drop Coming Soon!!";
const h1_presale_mint = "Pre-Sale Minting Open!!";
const h1_public_mint = "Public Minting Open!! TESTNET DO NOT SEND REAL ETHEREUM!!!";
...
const p_public_mint = "No whitelist needed. Public minting is now open! TESTNET DO NOT SEND REAL ETHEREUM!!!";
